...
public class MailController {
     ...
     */
    @PostMapping("/simple")
    public ResponseEntity<ApiResponse<ResultStatus>> sendSimpleMail(@Valid @RequestBody top.keke.model.Mail mail) {
     ...
     */
    @PostMapping("/html")
    public ResponseEntity<ApiResponse<ResultStatus>> sendHtmlMail(@Valid @RequestBody top.keke.model.Mail mail) {
    ...
    public ResponseEntity<ApiResponse<ResultStatus>> sendAttachmentsMail(@Valid @RequestPart("mail") top.keke.model.Mail mail, @RequestPart("files") MultipartFile[] files) {
