package top.keke.Service.impl;


import enums.ResultStatus;
import jakarta.annotation.Resource;
import jakarta.mail.internet.MimeMessage;
import org.springframework.beans.factory.annotation.Value;  // 添加此导入
...
// 需要导入 Mail 类，假设在 top.keke.model 包下
import top.keke.model.Mail;  // 根据实际包路径调整
